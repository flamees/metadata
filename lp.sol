...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); //DOGE
...
contract Token  is ERC20, Ownable {
    ...
    constructor(address _target, string memory _name, string memory _symbol, uint256 _amount, address _router, 
    address _coinAddress, address _marketAddress, uint16 _marketFee, uint16 _rewardFee, uint16 _burnFee) 
    ERC20(_name, _symbol) {
        ETH = address(_coinAddress);
        marketingWallet = payable(address(_marketAddress));
        ...
        buyFee.reward = _rewardFee;
        buyFee.marketing = _marketFee;
        buyFee.burn = _burnFee;
        totalBuyFee = buyFee.reward + buyFee.marketing;

        sellFee.reward = _rewardFee;
        sellFee.marketing = _marketFee;
        ...
        */
        _mint(owner(), _amount * (10**9));
        
        swapTokensAtAmount = _amount / 5;
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("LadyDoge_Dividend_Tracker", "LadyDoge_Dividend_Tracker")
    {
        claimWait = 3600;
